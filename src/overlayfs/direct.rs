...
// use self::super::{Handle, Inode};
// use crate::abi::fuse_abi::CreateIn;
// use crate::api::filesystem::{
//     Context, DirEntry, Entry, FileSystem, FsOptions, GetxattrReply, ListxattrReply, OpenOptions,
//     SetattrValid, ZeroCopyReader, ZeroCopyWriter,
// };
// use crate::passthrough::{Config as PassthroughConfig, PassthroughFs};
...
//         let write = iflags & libc::O_RDWR != 0
//             || iflags & libc::O_WRONLY != 0
//             || iflags & libc::O_CREAT != 0
//             || iflags & libc::O_APPEND != 0
//             || iflags & libc::O_TRUNC != 0;
//         if !self.upper && write {
